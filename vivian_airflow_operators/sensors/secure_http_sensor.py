...
class SecureHttpSensor(HttpSensor):  
    @apply_defaults
    def __init__(self, http_conn_id: str=None, authorization_type: str='Basic', *args, **kwargs) -> None:
    ...
    def execute(self, context):
        self.secure_http_hook = SecureHttpHook(http_conn_id=self.http_conn_id)
